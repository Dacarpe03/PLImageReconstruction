...
\subsection{Euclidean distances analysis for Zernike modes PSFs}
	...
	\subsubsection{Euclidean distances comparison evolution over number of zernike modes}
		\begin{figure*}[ht!]
			\centering
			\subfloat[Coefficients distances correlation evolution]{%
				\includegraphics[width=0.9\textwidth]{pid-edevolutioncoeffs.png}}
			\\
			\subfloat[PSF intensity distance correlation evolution]{%
				\includegraphics[width=0.45\textwidth]{pid-edevolutionpsf.png}}
			\hspace{\fill}
			\subfloat[Predicted PSF intensity distance correlation evolution]{%
				\includegraphics[width=0.45\textwidth]{pid-edevolutionpredpsf.png}}
			\\
			\subfloat[Coefficients vs PL flux for 9 zernike modes]{%
				\includegraphics[width=0.45\textwidth]{pid-edevolutioncroppedpsf.png}}
			\hspace{\fill}
			\subfloat[Coefficients vs PL flux for 2 zernike modes]{%
				\includegraphics[width=0.45\textwidth]{pid-edevolutionpredcroppedpsf.png}}
				
			\caption{Euclidean distances correlation evolution over number of Zernike modes}
		\end{figure*}
		\FloatBarrier
