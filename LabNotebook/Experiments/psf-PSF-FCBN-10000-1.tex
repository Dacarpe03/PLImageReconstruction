\rule{0.5\textwidth}{0.5pt}\\
	...
	*RESULTS:
	...
	\begin{figure*}[ht!]
		...
		\includegraphics[ width=0.31\textwidth]{psf-PSF-FCBN-10000-1-evolution.png}}
		\hspace{\fill}
		\subfloat[Validation example]{%
		\includegraphics[ width=0.31\textwidth]{psf-PSF-FCBN-10000-1-val.png}}
		\hspace{\fill}
		\subfloat[Train example]{%
		\includegraphics[ width=0.31\textwidth]{psf-PSF-FCBN-10000-1-train.png}}\\
