\section{Adjusted mutual information analysis with an arbitrary matrix}
	...
	\subsection{Detailed results}
		...
		The plot above is the only one for this project so there isn't a Part in \filename{appendix.pdf} dedicated to it.
