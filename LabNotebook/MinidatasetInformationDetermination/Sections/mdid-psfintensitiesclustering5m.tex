	\subsection{PSF Intensities clustering}
		...
		\subsubsection{K-Means}
			...
			\begin{figure*}[ht!]
				...
				\subfloat[Original cluster densities from PCA]{%
					\includegraphics[width=0.45\textwidth]{mdid-5mpcaintensitiesoriginaldensity.png}}
				\hspace{\fill}
				\subfloat[K-Means clusters densities from PCA]{%
					\includegraphics[width=0.45\textwidth]{mdid-5mpcaintensitiesK-Meansdensity.png}}\\
					
				\subfloat[Original cluster samples from PCA]{%
					\includegraphics[width=0.4\textwidth]{mdid-5mpcaintensitiesoriginalgridclusters.png}}
				\hspace{\fill}
				\subfloat[K-Means cluster samples from PCA]{%
					\includegraphics[width=0.4\textwidth]{mdid-5mpcaintensitiesK-Meansgridclusters.png}}
		...
		\subsubsection{DBSCAN}
			...
			\begin{figure*}[ht!]
				...
				\subfloat[DBSCAN clusters densities from PCA]{%
					\includegraphics[width=0.45\textwidth]{mdid-5mpcaintensitiesDBSCANdensity.png}}\\
					
				\subfloat[Original cluster samples from PCA]{%
					\includegraphics[width=0.4\textwidth]{mdid-5mpcaintensitiesoriginalgridclusters.png}}
				\hspace{\fill}
				\subfloat[DBSCAN cluster samples from PCA]{%
					\includegraphics[width=0.4\textwidth]{mdid-5mpcaintensitiesDBSCANgridclusters.png}}
		...
		\subsubsection{HDBSCAN}
			...
			\begin{figure*}[ht!]
				...
				\subfloat[HDBSCAN clusters densities from PCA]{%
					\includegraphics[width=0.45\textwidth]{mdid-5mpcaintensitiesHDBSCANdensity.png}}\\
					
				\subfloat[Original cluster samples from PCA]{%
					\includegraphics[width=0.4\textwidth]{mdid-5mpcaintensitiesoriginalgridclusters.png}}
				\hspace{\fill}
				\subfloat[HDBSCAN cluster samples from PCA]{%
					\includegraphics[width=0.4\textwidth]{mdid-5mpcaintensitiesHDBSCANgridclusters.png}}
		...
		\subsubsection{Agglomerative clustering}
			...
			\begin{figure*}[ht!]
				...
				\subfloat[Agglomerative clusters densities from PCA]{%
					\includegraphics[width=0.45\textwidth]{mdid-5mpcaintensitiesAgglomerativedensity.png}}
					
				\subfloat[Original cluster samples from PCA]{%
					\includegraphics[width=0.4\textwidth]{mdid-5mpcaintensitiesoriginalgridclusters.png}}
				\hspace{\fill}
				\subfloat[Agglomerative cluster samples from PCA]{%
					\includegraphics[width=0.4\textwidth]{mdid-5mpcaintensitiesAgglomerativegridclusters.png}}
		...
		\begin{figure*}[ht!]
				\centering
				\subfloat[Original cluster densities from PCA]{%
					\includegraphics[width=0.18\textwidth]{mdid-5mpcaintensitiesoriginaldensity.png}}
				\hspace{\fill}
				\subfloat[K-means cluster densities from PCA]{%
					\includegraphics[width=0.18\textwidth]{mdid-5mpcaintensitiesK-Meansdensity.png}}
				\hspace{\fill}
				\subfloat[DBSCAN cluster densities from PCA]{%
					\includegraphics[width=0.18\textwidth]{mdid-5mpcaintensitiesDBSCANdensity.png}}
				\hspace{\fill}
				\subfloat[HDBSCAN cluster densities from PCA]{%
					\includegraphics[width=0.18\textwidth]{mdid-5mpcaintensitiesHDBSCANdensity.png}}
				\hspace{\fill}
				\subfloat[Agglomerative cluster densities from PCA]{%
					\includegraphics[width=0.18\textwidth]{mdid-5mpcaintensitiesAgglomerativedensity.png}}
				\\
				
				\subfloat[Original cluster samples from PCA]{%
					\includegraphics[width=0.18\textwidth]{mdid-5mpcaintensitiesoriginalgridclusters.png}}
				\hspace{\fill}
				\subfloat[K-means cluster samples from PCA]{%
					\includegraphics[width=0.18\textwidth]{mdid-5mpcaintensitiesK-Meansgridclusters.png}}
				\hspace{\fill}
				\subfloat[DBSCAN cluster samplesfrom PCA]{%
					\includegraphics[width=0.18\textwidth]{mdid-5mpcaintensitiesDBSCANgridclusters.png}}
				\hspace{\fill}
				\subfloat[HDBSCAN cluster samples from PCA]{%
					\includegraphics[width=0.18\textwidth]{mdid-5mpcaintensitiesHDBSCANgridclusters.png}}
				\hspace{\fill}
				\subfloat[Agglomerative cluster samples from PCA]{%
					\includegraphics[width=0.18\textwidth]{mdid-5mpcaintensitiesAgglomerativegridclusters.png}}
