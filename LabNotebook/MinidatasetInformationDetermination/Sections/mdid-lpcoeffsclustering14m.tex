	\subsection{LP coefficients clustering}
		...
		\subsubsection{K-Means}
			...
			\begin{figure*}[ht!]
				...
				\subfloat[Original cluster densities]{%
					\includegraphics[width=0.45\textwidth]{mdid-14mlpcoefficientsoriginaldensity.png}}
				\hspace{\fill}
				\subfloat[K-Means clusters densities]{%
					\includegraphics[width=0.45\textwidth]{mdid-14mlpcoefficientsK-Meansdensity.png}}\\
					
				\subfloat[Original cluster samples]{%
					\includegraphics[width=0.4\textwidth]{mdid-14mlpcoefficientsoriginalgridclusters.png}}
				\hspace{\fill}
				\subfloat[K-Means cluster samples]{%
					\includegraphics[width=0.4\textwidth]{mdid-14mlpcoefficientsK-Meansgridclusters.png}}
		...
		\subsubsection{DBSCAN}
			...
			\begin{figure*}[ht!]
				...
				\subfloat[DBSCAN clusters densities]{%
					\includegraphics[width=0.45\textwidth]{mdid-14mlpcoefficientsDBSCANdensity.png}}\\
					
				\subfloat[Original cluster samples]{%
					\includegraphics[width=0.4\textwidth]{mdid-14mlpcoefficientsoriginalgridclusters.png}}
				\hspace{\fill}
				\subfloat[DBSCAN cluster samples]{%
					\includegraphics[width=0.4\textwidth]{mdid-14mlpcoefficientsDBSCANgridclusters.png}}
		...
		\subsubsection{HDBSCAN}
			...
			\begin{figure*}[ht!]
				...
				\subfloat[HDBSCAN clusters densities]{%
					\includegraphics[width=0.45\textwidth]{mdid-14mlpcoefficientsHDBSCANdensity.png}}\\
					
				\subfloat[Original cluster samples]{%
					\includegraphics[width=0.4\textwidth]{mdid-14mlpcoefficientsoriginalgridclusters.png}}
				\hspace{\fill}
				\subfloat[HDBSCAN cluster samples]{%
					\includegraphics[width=0.4\textwidth]{mdid-14mlpcoefficientsHDBSCANgridclusters.png}}
		...
		\subsubsection{Agglomerative clustering}
			...
			\begin{figure*}[ht!]
				...
				\subfloat[Agglomerative clusters densities]{%
					\includegraphics[width=0.45\textwidth]{mdid-14mlpcoefficientsAgglomerativedensity.png}}\\
					
				\subfloat[Original cluster samples]{%
					\includegraphics[width=0.4\textwidth]{mdid-14mlpcoefficientsoriginalgridclusters.png}}
				\hspace{\fill}
				\subfloat[Agglomerative cluster samples]{%
					\includegraphics[width=0.4\textwidth]{mdid-14mlpcoefficientsAgglomerativegridclusters.png}}
		...
		\subsubsection{Summary}
			\begin{figure*}[ht!]
				\centering
				\subfloat[Original cluster densities]{%
					\includegraphics[width=0.18\textwidth]{mdid-14mlpcoefficientsoriginaldensity.png}}
				\hspace{\fill}
				\subfloat[K-means cluster densities]{%
					\includegraphics[width=0.18\textwidth]{mdid-14mlpcoefficientsK-Meansdensity.png}}
				\hspace{\fill}
				\subfloat[DBSCAN cluster densities]{%
					\includegraphics[width=0.18\textwidth]{mdid-14mlpcoefficientsDBSCANdensity.png}}
				\hspace{\fill}
				\subfloat[HDBSCAN cluster densities]{%
					\includegraphics[width=0.18\textwidth]{mdid-14mlpcoefficientsHDBSCANdensity.png}}
				\hspace{\fill}
				\subfloat[Agglomerative cluster densities]{%
					\includegraphics[width=0.18\textwidth]{mdid-14mlpcoefficientsAgglomerativedensity.png}}\\
				
				\subfloat[Original cluster samples]{%
					\includegraphics[width=0.18\textwidth]{mdid-14mlpcoefficientsoriginalgridclusters.png}}
				\hspace{\fill}
				\subfloat[K-means cluster samples]{%
					\includegraphics[width=0.18\textwidth]{mdid-14mlpcoefficientsK-Meansgridclusters.png}}
				\hspace{\fill}
				\subfloat[DBSCAN cluster samples]{%
					\includegraphics[width=0.18\textwidth]{mdid-14mlpcoefficientsDBSCANgridclusters.png}}
				\hspace{\fill}
				\subfloat[HDBSCAN cluster samples]{%
					\includegraphics[width=0.18\textwidth]{mdid-14mlpcoefficientsHDBSCANgridclusters.png}}
				\hspace{\fill}
				\subfloat[Agglomerative cluster samples]{%
					\includegraphics[width=0.18\textwidth]{mdid-14mlpcoefficientsAgglomerativegridclusters.png}}
