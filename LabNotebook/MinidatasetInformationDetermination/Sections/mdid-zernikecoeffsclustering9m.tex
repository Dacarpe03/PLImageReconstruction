	...
	\subsection{Zernike coefficients clustering}
		...
		\subsubsection{K-Means}
			...
			\begin{figure*}[ht!]
				...
				\subfloat[Original cluster densities]{%
					\includegraphics[width=0.45\textwidth]{mdid-9mzernikecoefficientsoriginaldensity.png}}
				\hspace{\fill}
				\subfloat[K-Means clusters densities]{%
					\includegraphics[width=0.45\textwidth]{mdid-9mzernikecoefficientsK-Meansdensity.png}}\\
					
				\subfloat[Original cluster samples]{%
					\includegraphics[width=0.4\textwidth]{mdid-9mzernikecoefficientsoriginalgridclusters.png}}
				\hspace{\fill}
				\subfloat[K-Means cluster samples]{%
					\includegraphics[width=0.4\textwidth]{mdid-9mzernikecoefficientsK-Meansgridclusters.png}}
		...
		\subsubsection{DBSCAN}
			...
			\begin{figure*}[ht!]
				...
				\subfloat[DBSCAN clusters densities]{%
					\includegraphics[width=0.45\textwidth]{mdid-9mzernikecoefficientsDBSCANdensity.png}}\\
					
				\subfloat[Original cluster samples]{%
					\includegraphics[width=0.4\textwidth]{mdid-9mzernikecoefficientsoriginalgridclusters.png}}
				\hspace{\fill}
				\subfloat[DBSCAN cluster samples]{%
					\includegraphics[width=0.4\textwidth]{mdid-9mzernikecoefficientsDBSCANgridclusters.png}}
		...
		\subsubsection{HDBSCAN}
			...
			\begin{figure*}[ht!]
				...
				\subfloat[HDBSCAN clusters densities]{%
					\includegraphics[width=0.45\textwidth]{mdid-9mzernikecoefficientsHDBSCANdensity.png}}\\
					
				\subfloat[Original cluster samples]{%
					\includegraphics[width=0.4\textwidth]{mdid-9mzernikecoefficientsoriginalgridclusters.png}}
				\hspace{\fill}
				\subfloat[HDBSCAN cluster samples]{%
					\includegraphics[width=0.4\textwidth]{mdid-9mzernikecoefficientsHDBSCANgridclusters.png}}
		...
		\subsubsection{Agglomerative clustering}
			...
			\begin{figure*}[ht!]
				...
				\subfloat[Agglomerative clusters densities]{%
					\includegraphics[width=0.45\textwidth]{mdid-9mzernikecoefficientsAgglomerativedensity.png}}
				\\
				...
				\subfloat[Agglomerative cluster samples]{%
					\includegraphics[width=0.4\textwidth]{mdid-9mzernikecoefficientsAgglomerativegridclusters.png}}
		...
		\subsubsection{Summary}
			\begin{figure*}[ht!]
				\centering
				\subfloat[Original cluster densities]{%
					\includegraphics[width=0.18\textwidth]{mdid-9mzernikecoefficientsoriginaldensity.png}}
				\hspace{\fill}
				\subfloat[K-means cluster densities]{%
					\includegraphics[width=0.18\textwidth]{mdid-9mzernikecoefficientsK-Meansdensity.png}}
				\hspace{\fill}
				\subfloat[DBSCAN cluster densities]{%
					\includegraphics[width=0.18\textwidth]{mdid-9mzernikecoefficientsDBSCANdensity.png}}
				\hspace{\fill}
				\subfloat[HDBSCAN cluster densities]{%
					\includegraphics[width=0.18\textwidth]{mdid-9mzernikecoefficientsHDBSCANdensity.png}}
				\hspace{\fill}
				\subfloat[Agglomerative cluster densities]{%
					\includegraphics[width=0.18\textwidth]{mdid-9mzernikecoefficientsAgglomerativedensity.png}}\\
				
				\subfloat[Original cluster samples]{%
					\includegraphics[width=0.18\textwidth]{mdid-9mzernikecoefficientsoriginalgridclusters.png}}
				\hspace{\fill}
				\subfloat[K-means cluster samples]{%
					\includegraphics[width=0.18\textwidth]{mdid-9mzernikecoefficientsK-Meansgridclusters.png}}
				\hspace{\fill}
				\subfloat[DBSCAN cluster samples]{%
					\includegraphics[width=0.18\textwidth]{mdid-9mzernikecoefficientsDBSCANgridclusters.png}}
				\hspace{\fill}
				\subfloat[HDBSCAN cluster samples]{%
					\includegraphics[width=0.18\textwidth]{mdid-9mzernikecoefficientsHDBSCANgridclusters.png}}
				\hspace{\fill}
				\subfloat[Agglomerative cluster samples]{%
					\includegraphics[width=0.18\textwidth]{mdid-9mzernikecoefficientsAgglomerativegridclusters.png}}
