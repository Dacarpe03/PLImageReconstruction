...
model_configuration = ModelConfig(name="SuperBigCroppedZernike20MFC", n_samples=70000)
...
tc = load_numpy_data(f"{CROPPED_TRAIN_20M_ZERNIKE_COMPLEX_FIELDS_FILE_PREFIX}00.npy")
