...
from kobol_configurations import CroppedDR02FC as ModelConfig
...
model_configuration = ModelConfig(n_samples=10000)
...
plot_model_history(history, model.name, top_y_lim=0.2, show_plot=False, save_image=True)
