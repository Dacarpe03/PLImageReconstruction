...
from psf_constants import PROCESSED_TRAIN_14M_ZERNIKE_OUTPUT_FLUXES_FILE_PREFIX, \
...
validation_complex_fields_array = load_numpy_data(CROPPED_VALIDATION_14M_ZERNIKE_COMPLEX_FIELDS_INTENSITY_FILE_PATH)
...
model_configuration = ModelConfig(name="SuperBigCroppedZernike14MFCIntensity", n_samples=70000)
...
tc = load_numpy_data(f"{CROPPED_TRAIN_14M_ZERNIKE_COMPLEX_FIELDS_INTENSITY_FILE_PREFIX}00.npy")
