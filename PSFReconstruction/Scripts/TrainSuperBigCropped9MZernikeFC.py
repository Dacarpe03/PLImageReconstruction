...
validation_complex_fields_array = load_numpy_data(CROPPED_VALIDATION_9M_ZERNIKE_COMPLEX_FIELDS_FILE_PATH)
...
model_configuration = ModelConfig(name="SuperBigCroppedZernike9MFC", n_samples=70000)
...
tc = load_numpy_data(f"{CROPPED_TRAIN_9M_ZERNIKE_COMPLEX_FIELDS_FILE_PREFIX}00.npy")
