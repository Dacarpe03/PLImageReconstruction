...
validation_complex_fields_array = load_numpy_data(CROPPED_VALIDATION_20M_ZERNIKE_COMPLEX_FIELDS_INTENSITY_FILE_PATH)
...
model_configuration = ModelConfig(name="SuperBigCroppedZernike20MFCIntensity", n_samples=70000)
...
n = 2
tf = load_numpy_data(f"{PROCESSED_TRAIN_20M_ZERNIKE_OUTPUT_FLUXES_FILE_PREFIX}00.npy")
tc = load_numpy_data(f"{CROPPED_TRAIN_20M_ZERNIKE_COMPLEX_FIELDS_INTENSITY_FILE_PREFIX}00.npy")
