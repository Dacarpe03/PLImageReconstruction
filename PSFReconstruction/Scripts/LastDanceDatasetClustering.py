...
number_of_clusters = [4, 8, 16, 32, 64, 100, 250, 500, 1000, 2000]
...
minidataset_name = "NMI_ANALYSIS_9M_20000"
minidataset_dict = PATHS_DICTIONARY[minidataset_name]
...
for n_clusters in number_of_clusters:
    cluster_suffix = f"_{n_clusters}kmeans.npy"
    print(f"Computing {n_clusters} K-Means cluters for dataset {minidataset_name}")
