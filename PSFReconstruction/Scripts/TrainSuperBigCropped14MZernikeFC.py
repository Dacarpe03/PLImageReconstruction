...
model_configuration = ModelConfig(name="SuperBigCroppedZernike14MFC", n_samples=70000)
...
tc = load_numpy_data(f"{CROPPED_TRAIN_14M_ZERNIKE_COMPLEX_FIELDS_FILE_PREFIX}00.npy")
