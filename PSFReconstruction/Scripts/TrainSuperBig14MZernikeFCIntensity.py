...
validation_complex_fields_array = load_numpy_data(PROCESSED_VALIDATION_14M_ZERNIKE_COMPLEX_FIELDS_INTENSITY_FILE_PATH)
...
model_configuration = ModelConfig(name="SuperBigZernike14MFCIntensity", n_samples=70000)
