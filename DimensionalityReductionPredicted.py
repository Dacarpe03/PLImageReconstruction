...
from psf_constants import FC_PREDICTED_TRAIN_2M_ZERNIKE_COMPLEX_FIELDS_FILE_PREFIX, \
                          ...
                          LOW_DIMENSIONALITY_PREDICTED_TRAIN_2M_ZERNIKE_COMPLEX_FIELDS_INTENSITY_FILE_PATH, \
...
PATH_DICTIONARY = {
    ...
    "TRI2": [FC_PREDICTED_TRAIN_2M_ZERNIKE_COMPLEX_FIELDS_INTENSITIES_FILE_PREFIX, 
            LOW_DIMENSIONALITY_PREDICTED_TRAIN_2M_ZERNIKE_COMPLEX_FIELDS_INTENSITY_FILE_PATH],
    "TRI5": [FC_PREDICTED_TRAIN_5M_ZERNIKE_COMPLEX_FIELDS_INTENSITIES_FILE_PREFIX, 
            LOW_DIMENSIONALITY_PREDICTED_TRAIN_5M_ZERNIKE_COMPLEX_FIELDS_INTENSITY_FILE_PATH],
    "TRI9": [FC_PREDICTED_TRAIN_9M_ZERNIKE_COMPLEX_FIELDS_INTENSITIES_FILE_PREFIX, 
            LOW_DIMENSIONALITY_PREDICTED_TRAIN_9M_ZERNIKE_COMPLEX_FIELDS_INTENSITY_FILE_PATH],
    "TRI14": [FC_PREDICTED_TRAIN_14M_ZERNIKE_COMPLEX_FIELDS_INTENSITIES_FILE_PREFIX, 
             LOW_DIMENSIONALITY_PREDICTED_TRAIN_14M_ZERNIKE_COMPLEX_FIELDS_INTENSITY_FILE_PATH],
    "TRI20": [FC_PREDICTED_TRAIN_20M_ZERNIKE_COMPLEX_FIELDS_INTENSITIES_FILE_PREFIX,
             LOW_DIMENSIONALITY_PREDICTED_TRAIN_20M_ZERNIKE_COMPLEX_FIELDS_INTENSITY_FILE_PATH]
}
