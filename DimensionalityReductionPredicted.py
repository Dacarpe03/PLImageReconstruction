...
from psf_constants import PROCESSED_TRAIN_2M_ZERNIKE_COMPLEX_FIELDS_INTENSITY_FILE_PREFIX, \
                          ...
                          LOW_DIMENSION_TRAIN_2M_ZERNIKE_COMPLEX_FIELDS_INTENSITY_FILE_PATH, \
                          LOW_DIMENSION_TRAIN_5M_ZERNIKE_COMPLEX_FIELDS_FILE_INTENSITY_PATH, \
...
PATH_DICTIONARY = {
    "TR2": [PROCESSED_TRAIN_2M_ZERNIKE_COMPLEX_FIELDS_INTENSITY_FILE_PREFIX, 
            LOW_DIMENSION_TRAIN_2M_ZERNIKE_COMPLEX_FIELDS_INTENSITY_FILE_PATH],
    "TR5": [PROCESSED_TRAIN_5M_ZERNIKE_COMPLEX_FIELDS_INTENSITY_FILE_PREFIX, 
            LOW_DIMENSION_TRAIN_5M_ZERNIKE_COMPLEX_FIELDS_INTENSITY_FILE_PATH],
    "TR9": [PROCESSED_TRAIN_9M_ZERNIKE_COMPLEX_FIELDS_INTENSITY_FILE_PREFIX, 
            LOW_DIMENSION_TRAIN_9M_ZERNIKE_COMPLEX_FIELDS_INTENSITY_FILE_PATH],
    "TR14": [PROCESSED_TRAIN_14M_ZERNIKE_COMPLEX_FIELDS_INTENSITY_FILE_PREFIX, 
             LOW_DIMENSION_TRAIN_14M_ZERNIKE_COMPLEX_FIELDS_INTENSITY_FILE_PATH],
    "TR20": [PROCESSED_TRAIN_20M_ZERNIKE_COMPLEX_FIELDS_INTENSITY_FILE_PREFIX,
             LOW_DIMENSION_TRAIN_20M_ZERNIKE_COMPLEX_FIELDS_INTENSITY_FILE_PATH]
}
