...
# ARBITRARY MATRIX, 9 modes Files paths, 10000 points
ARBITRARY_ZERNIKE_9M_10000_COMPLEX_FIELDS_FILE_PATH = f"{ZERNIKE_COMPLEX_FIELDS_FOLDER_PATH}/arbitrary_matrix_9M_10000_{ZERNIKE_COMPLEX_FIELDS_FILE_NAME}{NUMPY_SUFFIX}"
ARBITRARY_ZERNIKE_9M_10000_MODE_COEFFICIENTS_FILE_PATH = f"{ZERNIKE_MODES_FOLDER_PATH}/arbitrary_matrix_9M_10000_{ZERNIKE_MODE_COEFFICIENTS_FILE_NAME}{NUMPY_SUFFIX}"
ARBITRARY_ZERNIKE_9M_10000_PSF_LP_MODES_FILE_PATH = f"{ZERNIKE_PSF_LP_MODES_FOLDER_PATH}/arbitrary_matrix_9M_10000_{ZERNIKE_PSF_LP_MODES_FILE_NAME}{NUMPY_SUFFIX}"
ARBITRARY_ZERNIKE_9M_10000_OUTPUT_FLUXES_FILE_PATH = f"{ZERNIKE_OUTPUT_FLUXES_FOLDER_PATH}/arbitrary_matrix_9M_10000_{ZERNIKE_OUTPUT_FLUXES_FILE_NAME}{NUMPY_SUFFIX}"
ARBITRARY_ZERNIKE_9M_10000_COMPLEX_OUTPUT_FLUXES_FILE_PATH = f"{ZERNIKE_OUTPUT_FLUXES_FOLDER_PATH}/arbitrary_matrix_9M_10000_{ZERNIKE_COMPLEX_OUTPUT_FLUXES_FILE_NAME}{NUMPY_SUFFIX}"

ARBITRARY_PROCESSED_ZERNIKE_9M_10000_COMPLEX_FIELDS_INTENSITY_FILE_PATH = f"{PROCESSED_ZERNIKE_COMPLEX_FIELDS_PATH}/arbitrary_matrix_9M_10000_{ZERNIKE_INTENSITIES_FILE_NAME}{NUMPY_SUFFIX}"
ARBITRARY_ZERNIKE_9M_10000_PSF_INTENSITIES_UMAP_FILE_PATH= f"{PROCESSED_ZERNIKE_COMPLEX_FIELDS_PATH}/arbitrary_matrix_umap_9M_10000_{ZERNIKE_INTENSITIES_FILE_NAME}{NUMPY_SUFFIX}"
ARBITRARY_ZERNIKE_9M_10000_PSF_COMPLEX_FIELDS_UMAP_FILE_PATH= f"{PROCESSED_ZERNIKE_COMPLEX_FIELDS_PATH}/arbitrary_matrix_umap_9M_10000_{ZERNIKE_COMPLEX_FIELDS_FILE_NAME}{NUMPY_SUFFIX}"

ARBITRARY_ZERNIKE_9M_10000_COMPLEX_FIELDS_INTENSITY_LABELS_FILE_PATH = f"{CLUSTER_LABELS_FOLDER_PATH}/arbitrary_matrix_labels_9M_10000_{ZERNIKE_INTENSITIES_FILE_NAME}"
ARBITRARY_ZERNIKE_9M_10000_COMPLEX_FIELDS_LABELS_FILE_PATH = f"{CLUSTER_LABELS_FOLDER_PATH}/arbitrary_matrix_labels_9M_10000_{ZERNIKE_COMPLEX_FIELDS_FILE_NAME}"
ARBITRARY_ZERNIKE_9M_10000_MODE_COEFFICIENTS_LABELS_FILE_PATH = f"{CLUSTER_LABELS_FOLDER_PATH}/arbitrary_matrix_labels_9M_10000_{ZERNIKE_MODE_COEFFICIENTS_FILE_NAME}"
ARBITRARY_ZERNIKE_9M_10000_PSF_LP_MODES_LABELS_FILE_PATH = f"{CLUSTER_LABELS_FOLDER_PATH}/arbitrary_matrix_labels_9M_10000_{ZERNIKE_PSF_LP_MODES_FILE_NAME}"
ARBITRARY_ZERNIKE_9M_10000_OUTPUT_FLUXES_LABELS_FILE_PATH = f"{CLUSTER_LABELS_FOLDER_PATH}/arbitrary_matrix_labels_9M_10000_{ZERNIKE_OUTPUT_FLUXES_FILE_NAME}"
ARBITRARY_ZERNIKE_9M_10000_COMPLEX_OUTPUT_FLUXES_LABELS_FILE_PATH = f"{CLUSTER_LABELS_FOLDER_PATH}/arbitrary_matrix_labels_9M_10000_{ZERNIKE_COMPLEX_OUTPUT_FLUXES_FILE_NAME}"
...
PATHS_DICTIONARY = {
	"NMI_ANALYSIS_9M_500":{
		...
		"zernike_can_be_negative": [False,
									...
									False],
		"n_samples": 500,
		"n_clusters": [10, 20, 50, 100, 250]
	},

	"NMI_ANALYSIS_9M_1000":{
		"complex_fields_path": ZERNIKE_9M_1000_COMPLEX_FIELDS_FILE_PATH,
		"umap_complex_fields_path": ZERNIKE_9M_1000_PSF_COMPLEX_FIELDS_UMAP_FILE_PATH,
		"intensities_file_path": PROCESSED_ZERNIKE_9M_1000_COMPLEX_FIELDS_INTENSITY_FILE_PATH,
		"umap_intensities_path": ZERNIKE_9M_1000_PSF_INTENSITIES_UMAP_FILE_PATH,
		"complex_fields_labels_path": ZERNIKE_9M_1000_COMPLEX_FIELDS_LABELS_FILE_PATH,
		"intensities_labels_path": ZERNIKE_9M_1000_COMPLEX_FIELDS_INTENSITY_LABELS_FILE_PATH,
		"zernike_mode_coefficients_path": ZERNIKE_9M_1000_MODE_COEFFICIENTS_FILE_PATH,
		"zernike_mode_coefficients_labels_path": ZERNIKE_9M_1000_MODE_COEFFICIENTS_LABELS_FILE_PATH,
		"lp_modes_path": ZERNIKE_9M_1000_PSF_LP_MODES_FILE_PATH,
		"lp_modes_labels_path": ZERNIKE_9M_1000_PSF_LP_MODES_LABELS_FILE_PATH,
		"complex_output_fluxes_path": ZERNIKE_9M_1000_COMPLEX_OUTPUT_FLUXES_FILE_PATH,
		"output_fluxes_path": ZERNIKE_9M_1000_OUTPUT_FLUXES_FILE_PATH,
		"complex_output_fluxes_labels_path": ZERNIKE_9M_1000_COMPLEX_OUTPUT_FLUXES_LABELS_FILE_PATH,
		"output_fluxes_labels_path": ZERNIKE_9M_1000_OUTPUT_FLUXES_LABELS_FILE_PATH,
		"zernike_mode_indexes": [2, 3, 4, 5, 6, 7, 8, 9, 10],
		"zernike_coefficients_range": [
		[-0.22, 0.22],
		[-0.22, 0.22],
		...
		"zernike_can_be_negative": [False,
									...
									False],
		"n_samples": 1000,
		"n_clusters": [20, 50, 100, 250, 500]
	},

	"NMI_ANALYSIS_9M_2000":{
		"complex_fields_path": ZERNIKE_9M_2000_COMPLEX_FIELDS_FILE_PATH,
		"umap_complex_fields_path": ZERNIKE_9M_2000_PSF_COMPLEX_FIELDS_UMAP_FILE_PATH,
		"intensities_file_path": PROCESSED_ZERNIKE_9M_2000_COMPLEX_FIELDS_INTENSITY_FILE_PATH,
		"umap_intensities_path": ZERNIKE_9M_2000_PSF_INTENSITIES_UMAP_FILE_PATH,
		"complex_fields_labels_path": ZERNIKE_9M_2000_COMPLEX_FIELDS_LABELS_FILE_PATH,
		"intensities_labels_path": ZERNIKE_9M_2000_COMPLEX_FIELDS_INTENSITY_LABELS_FILE_PATH,
		"zernike_mode_coefficients_path": ZERNIKE_9M_2000_MODE_COEFFICIENTS_FILE_PATH,
		"zernike_mode_coefficients_labels_path": ZERNIKE_9M_2000_MODE_COEFFICIENTS_LABELS_FILE_PATH,
		"lp_modes_path": ZERNIKE_9M_2000_PSF_LP_MODES_FILE_PATH,
		"lp_modes_labels_path": ZERNIKE_9M_2000_PSF_LP_MODES_LABELS_FILE_PATH,
		"complex_output_fluxes_path": ZERNIKE_9M_2000_COMPLEX_OUTPUT_FLUXES_FILE_PATH,
		"output_fluxes_path": ZERNIKE_9M_2000_OUTPUT_FLUXES_FILE_PATH,
		"complex_output_fluxes_labels_path": ZERNIKE_9M_2000_COMPLEX_OUTPUT_FLUXES_LABELS_FILE_PATH,
		"output_fluxes_labels_path": ZERNIKE_9M_2000_OUTPUT_FLUXES_LABELS_FILE_PATH,
		"zernike_mode_indexes": [2, 3, 4, 5, 6, 7, 8, 9, 10],
		"zernike_coefficients_range": [
		[-0.22, 0.22],
		[-0.22, 0.22],
		...
		"zernike_can_be_negative": [False,
									...
									False],
		"n_samples": 2000,
		"n_clusters": [50, 100, 250, 500, 1000]
	},

	"NMI_ANALYSIS_9M_5000":{
		"complex_fields_path": ZERNIKE_9M_5000_COMPLEX_FIELDS_FILE_PATH,
		"umap_complex_fields_path": ZERNIKE_9M_5000_PSF_COMPLEX_FIELDS_UMAP_FILE_PATH,
		"intensities_file_path": PROCESSED_ZERNIKE_9M_5000_COMPLEX_FIELDS_INTENSITY_FILE_PATH,
		"umap_intensities_path": ZERNIKE_9M_5000_PSF_INTENSITIES_UMAP_FILE_PATH,
		"complex_fields_labels_path": ZERNIKE_9M_5000_COMPLEX_FIELDS_LABELS_FILE_PATH,
		"intensities_labels_path": ZERNIKE_9M_5000_COMPLEX_FIELDS_INTENSITY_LABELS_FILE_PATH,
		"zernike_mode_coefficients_path": ZERNIKE_9M_5000_MODE_COEFFICIENTS_FILE_PATH,
		"zernike_mode_coefficients_labels_path": ZERNIKE_9M_5000_MODE_COEFFICIENTS_LABELS_FILE_PATH,
		"lp_modes_path": ZERNIKE_9M_5000_PSF_LP_MODES_FILE_PATH,
		"lp_modes_labels_path": ZERNIKE_9M_5000_PSF_LP_MODES_LABELS_FILE_PATH,
		"complex_output_fluxes_path": ZERNIKE_9M_5000_COMPLEX_OUTPUT_FLUXES_FILE_PATH,
		"output_fluxes_path": ZERNIKE_9M_5000_OUTPUT_FLUXES_FILE_PATH,
		"complex_output_fluxes_labels_path": ZERNIKE_9M_5000_COMPLEX_OUTPUT_FLUXES_LABELS_FILE_PATH,
		"output_fluxes_labels_path": ZERNIKE_9M_5000_OUTPUT_FLUXES_LABELS_FILE_PATH,
		"zernike_mode_indexes": [2, 3, 4, 5, 6, 7, 8, 9, 10],
		"zernike_coefficients_range": [
		[-0.22, 0.22],
		[-0.22, 0.22],
		...
		"zernike_can_be_negative": [False,
									...
									False],
		"n_samples": 5000,
		"n_clusters": [50, 100, 250, 500, 1000, 2500]
	},

	"NMI_ANALYSIS_9M_10000":{
		"complex_fields_path": ZERNIKE_9M_10000_COMPLEX_FIELDS_FILE_PATH,
		"umap_complex_fields_path": ZERNIKE_9M_10000_PSF_COMPLEX_FIELDS_UMAP_FILE_PATH,
		"intensities_file_path": PROCESSED_ZERNIKE_9M_10000_COMPLEX_FIELDS_INTENSITY_FILE_PATH,
		"umap_intensities_path": ZERNIKE_9M_10000_PSF_INTENSITIES_UMAP_FILE_PATH,
		"complex_fields_labels_path": ZERNIKE_9M_10000_COMPLEX_FIELDS_LABELS_FILE_PATH,
		"intensities_labels_path": ZERNIKE_9M_10000_COMPLEX_FIELDS_INTENSITY_LABELS_FILE_PATH,
		"zernike_mode_coefficients_path": ZERNIKE_9M_10000_MODE_COEFFICIENTS_FILE_PATH,
		"zernike_mode_coefficients_labels_path": ZERNIKE_9M_10000_MODE_COEFFICIENTS_LABELS_FILE_PATH,
		"lp_modes_path": ZERNIKE_9M_10000_PSF_LP_MODES_FILE_PATH,
		"lp_modes_labels_path": ZERNIKE_9M_10000_PSF_LP_MODES_LABELS_FILE_PATH,
		"complex_output_fluxes_path": ZERNIKE_9M_10000_COMPLEX_OUTPUT_FLUXES_FILE_PATH,
		"output_fluxes_path": ZERNIKE_9M_10000_OUTPUT_FLUXES_FILE_PATH,
		"complex_output_fluxes_labels_path": ZERNIKE_9M_10000_COMPLEX_OUTPUT_FLUXES_LABELS_FILE_PATH,
		"output_fluxes_labels_path": ZERNIKE_9M_10000_OUTPUT_FLUXES_LABELS_FILE_PATH,
		"zernike_mode_indexes": [2, 3, 4, 5, 6, 7, 8, 9, 10],
		"zernike_coefficients_range": [
		[-0.22, 0.22],
		[-0.22, 0.22],
		...
		"zernike_can_be_negative": [False,
									...
									False],
		"n_samples": 10000,
		"n_clusters": [50, 100, 250, 500, 1000, 2500, 5000]
	},

	"NMI_ANALYSIS_9M_20000":{
		"complex_fields_path": ZERNIKE_9M_20000_COMPLEX_FIELDS_FILE_PATH,
		"umap_complex_fields_path": ZERNIKE_9M_20000_PSF_COMPLEX_FIELDS_UMAP_FILE_PATH,
		"intensities_file_path": PROCESSED_ZERNIKE_9M_20000_COMPLEX_FIELDS_INTENSITY_FILE_PATH,
		"umap_intensities_path": ZERNIKE_9M_20000_PSF_INTENSITIES_UMAP_FILE_PATH,
		"complex_fields_labels_path": ZERNIKE_9M_20000_COMPLEX_FIELDS_LABELS_FILE_PATH,
		"intensities_labels_path": ZERNIKE_9M_20000_COMPLEX_FIELDS_INTENSITY_LABELS_FILE_PATH,
		"zernike_mode_coefficients_path": ZERNIKE_9M_20000_MODE_COEFFICIENTS_FILE_PATH,
		"zernike_mode_coefficients_labels_path": ZERNIKE_9M_20000_MODE_COEFFICIENTS_LABELS_FILE_PATH,
		"lp_modes_path": ZERNIKE_9M_20000_PSF_LP_MODES_FILE_PATH,
		"lp_modes_labels_path": ZERNIKE_9M_20000_PSF_LP_MODES_LABELS_FILE_PATH,
		"complex_output_fluxes_path": ZERNIKE_9M_20000_COMPLEX_OUTPUT_FLUXES_FILE_PATH,
		"output_fluxes_path": ZERNIKE_9M_20000_OUTPUT_FLUXES_FILE_PATH,
		"complex_output_fluxes_labels_path": ZERNIKE_9M_20000_COMPLEX_OUTPUT_FLUXES_LABELS_FILE_PATH,
		"output_fluxes_labels_path": ZERNIKE_9M_20000_OUTPUT_FLUXES_LABELS_FILE_PATH,
		"zernike_mode_indexes": [2, 3, 4, 5, 6, 7, 8, 9, 10],
		"zernike_coefficients_range": [
		[-0.22, 0.22],
		[-0.22, 0.22],
...
ARBITRARY_EXPERIMENT_PATHS_DICTIONARY = {
	"ARBITRARY_AMI_ANALYSIS_9M_10000":{
		"complex_fields_path": ARBITRARY_ZERNIKE_9M_10000_COMPLEX_FIELDS_FILE_PATH,
		"umap_complex_fields_path": ARBITRARY_ZERNIKE_9M_10000_PSF_COMPLEX_FIELDS_UMAP_FILE_PATH,
		"intensities_file_path": ARBITRARY_PROCESSED_ZERNIKE_9M_10000_COMPLEX_FIELDS_INTENSITY_FILE_PATH,
		"umap_intensities_path": ARBITRARY_ZERNIKE_9M_10000_PSF_INTENSITIES_UMAP_FILE_PATH,
		"complex_fields_labels_path": ARBITRARY_ZERNIKE_9M_10000_COMPLEX_FIELDS_LABELS_FILE_PATH,
		"intensities_labels_path": ARBITRARY_ZERNIKE_9M_10000_COMPLEX_FIELDS_INTENSITY_LABELS_FILE_PATH,
		"zernike_mode_coefficients_path": ARBITRARY_ZERNIKE_9M_10000_MODE_COEFFICIENTS_FILE_PATH,
		"zernike_mode_coefficients_labels_path": ARBITRARY_ZERNIKE_9M_10000_MODE_COEFFICIENTS_LABELS_FILE_PATH,
		"lp_modes_path": ARBITRARY_ZERNIKE_9M_10000_PSF_LP_MODES_FILE_PATH,
		"lp_modes_labels_path": ARBITRARY_ZERNIKE_9M_10000_PSF_LP_MODES_LABELS_FILE_PATH,
		"complex_output_fluxes_path": ARBITRARY_ZERNIKE_9M_10000_COMPLEX_OUTPUT_FLUXES_FILE_PATH,
		"output_fluxes_path": ARBITRARY_ZERNIKE_9M_10000_OUTPUT_FLUXES_FILE_PATH,
		"complex_output_fluxes_labels_path": ARBITRARY_ZERNIKE_9M_10000_COMPLEX_OUTPUT_FLUXES_LABELS_FILE_PATH,
		"output_fluxes_labels_path": ARBITRARY_ZERNIKE_9M_10000_OUTPUT_FLUXES_LABELS_FILE_PATH,
		"zernike_mode_indexes": [2, 3, 4, 5, 6, 7, 8, 9, 10],
		"zernike_coefficients_range": [
		[-0.22, 0.22],
		[-0.22, 0.22],
