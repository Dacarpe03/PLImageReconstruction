...
TRAIN_FOLDER = f"{PROCESSED_DATA_FOLDER}/TrainData"wiki
...
VALIDATION_COMPLEX_FIELDS_PATH = f"{VALIDATION_COMPLEX_FIELDS_FOLDER_PATH}/{COMPLEX_FIELDS_FILE_NAME}{VALIDATION_FILE_SUFFIX}{NUMPY_SUFFIX}"
TEST_COMPLEX_FIELDS_PATH = f"{TEST_COMPLEX_FIELDS_FOLDER_PATH}/{COMPLEX_FIELDS_FILE_NAME}{TEST_FILE_SUFFIX}{NUMPY_SUFFIX}"
