...
VALIDATION_OUTPUT_FLUXES_FILE_PATH = f"{VALIDATION_OUTPUT_FLUXES_FOLDER_PATH}/{OUTPUT_FLUXES_FILE_NAME}{VALIDATION_FILE_SUFFIX}{NUMPY_SUFFIX}"
TEST_OUTPUT_FLUXES_FILE_PATH = f"{TEST_OUTPUT_FLUXES_FOLDER_PATH}/{OUTPUT_FLUXES_FILE_NAME}{TEST_FILE_SUFFIX}{NUMPY_SUFFIX}"
