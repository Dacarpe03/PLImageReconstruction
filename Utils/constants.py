...
TRAIN_COMPLEX_FIELDS_DATA_PATH = f"{COMPLEX_FIELDS_DATA_PATH}/TrainData"
VALIDATION_COMPLEX_FIELDS_DATA_PATH = f"{COMPLEX_FIELDS_DATA_PATH}/ValidationData"
TEST_COMPLEX_FIELDS_DATA_PATH = f"{COMPLEX_FIELDS_DATA_PATH}/TestData"

TRAIN_COMPLEX_FIELD_PREFIX = f"{TRAIN_COMPLEX_FIELDS_DATA_PATH}/complex_fields"
VALIDATION_COMPLEX_FIELD_PATH = f"{VALIDATION_COMPLEX_FIELDS_DATA_PATH}/complex_fields{VALIDATION_FILE_SUFFIX}{NUMPY_SUFFIX}"
TEST_COMPLEX_FIELD_PATH = f"{TEST_COMPLEX_FIELDS_DATA_PATH}/complex_fields{TEST_FILE_SUFFIX}{NUMPY_SUFFIX}"
