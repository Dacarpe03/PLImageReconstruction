...
TRAIN_ZERNIKE_COMPLEX_FIELDS_PREFIX = f"{TRAIN_ZERNIKE_COMPLEX_FIELDS_FOLDER_PATH}/{ZERNIKE_COMPLEX_FIELDS_FILE_NAME}"
VALIDATION_ZERNIKE_COMPLEX_FIELDS_PATH = f"{VALIDATION_ZERNIKE_COMPLEX_FIELDS_FOLDER_PATH}/{ZERNIKE_COMPLEX_FIELDS_FILE_NAME}{PSF_VALIDATION_FILE_SUFFIX}{NUMPY_SUFFIX}"
TEST_ZERNIKE_COMPLEX_FIELDS_PATH = f"{TEST_CZERNIKE_OMPLEX_FIELDS_FOLDER_PATH}/{ZERNIKE_COMPLEX_FIELDS_FILE_NAME}{PSF_TEST_FILE_SUFFIX}{NUMPY_SUFFIX}"
