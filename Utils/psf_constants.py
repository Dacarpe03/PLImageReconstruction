...
ARBITRARY_MATRIX = f"{PSF_DATA_PATH}/arbitrary_transfer_matrix_19_modes{NUMPY_SUFFIX}"
...
LOW_DIMENSION_TRAIN_5M_ZERNIKE_COMPLEX_FIELDS_INTENSITY_FILE_PATH = f"{PROCESSED_TRAIN_ZERNIKE_COMPLEX_FIELDS_FOLDER_PATH}/ld_5M_{ZERNIKE_INTENSITIES_FILE_NAME}{NUMPY_SUFFIX}"
...
PSF_INTENSITY_CLUSTER_FILE_NAME = "psf_intensity_clusters"
...
# Cluster PSFs electric intensities
CLUSTER_DBSCAN_TRAIN_2M_ZERNIKE_PSF_INTENSITY_FILE_PATH = f"{TRAIN_CLUSTERS_FOLDER_PATH}/dbscan_2M_ZERNIKE_{PSF_INTENSITY_CLUSTER_FILE_NAME}{NUMPY_SUFFIX}"
CLUSTER_DBSCAN_TRAIN_5M_ZERNIKE_PSF_INTENSITY_FILE_PATH = f"{TRAIN_CLUSTERS_FOLDER_PATH}/dbscan_5M_ZERNIKE_{PSF_INTENSITY_CLUSTER_FILE_NAME}{NUMPY_SUFFIX}"
CLUSTER_DBSCAN_TRAIN_9M_ZERNIKE_PSF_INTENSITY_FILE_PATH = f"{TRAIN_CLUSTERS_FOLDER_PATH}/dbscan_9M_ZERNIKE_{PSF_INTENSITY_CLUSTER_FILE_NAME}{NUMPY_SUFFIX}"
CLUSTER_DBSCAN_TRAIN_14M_ZERNIKE_PSF_INTENSITY_FILE_PATH = f"{TRAIN_CLUSTERS_FOLDER_PATH}/dbscan_14M_ZERNIKE_{PSF_INTENSITY_CLUSTER_FILE_NAME}{NUMPY_SUFFIX}"
CLUSTER_DBSCAN_TRAIN_20M_ZERNIKE_PSF_INTENSITY_FILE_PATH = f"{TRAIN_CLUSTERS_FOLDER_PATH}/dbscan_20M_ZERNIKE_{PSF_INTENSITY_CLUSTER_FILE_NAME}{NUMPY_SUFFIX}"

# Cluster PSFs predicted electric fields
...
# Cluster PSFs electric intensities
CLUSTER_DBSCAN_PREDICTED_TRAIN_2M_ZERNIKE_PSF_INTENSITY_FILE_PATH = f"{TRAIN_CLUSTERS_FOLDER_PATH}/dbscan_predicted_2M_ZERNIKE_{PSF_INTENSITY_CLUSTER_FILE_NAME}{NUMPY_SUFFIX}"
CLUSTER_DBSCAN_PREDICTED_TRAIN_5M_ZERNIKE_PSF_INTENSITY_FILE_PATH = f"{TRAIN_CLUSTERS_FOLDER_PATH}/dbscan_predicted_5M_ZERNIKE_{PSF_INTENSITY_CLUSTER_FILE_NAME}{NUMPY_SUFFIX}"
CLUSTER_DBSCAN_PREDICTED_TRAIN_9M_ZERNIKE_PSF_INTENSITY_FILE_PATH = f"{TRAIN_CLUSTERS_FOLDER_PATH}/dbscan_predicted_9M_ZERNIKE_{PSF_INTENSITY_CLUSTER_FILE_NAME}{NUMPY_SUFFIX}"
CLUSTER_DBSCAN_PREDICTED_TRAIN_14M_ZERNIKE_PSF_INTENSITY_FILE_PATH = f"{TRAIN_CLUSTERS_FOLDER_PATH}/dbscan_predicted_14M_ZERNIKE_{PSF_INTENSITY_CLUSTER_FILE_NAME}{NUMPY_SUFFIX}"
CLUSTER_DBSCAN_PREDICTED_TRAIN_20M_ZERNIKE_PSF_INTENSITY_FILE_PATH = f"{TRAIN_CLUSTERS_FOLDER_PATH}/dbscan_predicted_20M_ZERNIKE_{PSF_INTENSITY_CLUSTER_FILE_NAME}{NUMPY_SUFFIX}"
