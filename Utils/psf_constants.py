...
FC_PREDICTED_TRAIN_INTENSITIES_PREFIX = f"{FC_PREDICTED_TRAIN_COMPLEX_FIELDS_FOLDER_PATH}/fc_predicted_{ZERNIKE_INTENSITIES_FILE_NAME}"
FC_PREDICTED_CROPPED_TRAIN_COMPLEX_FIELDS_INTENSITIES_PREFIX = f"{FC_PREDICTED_TRAIN_COMPLEX_FIELDS_FOLDER_PATH}/fc_predicted_cropped_{ZERNIKE_INTENSITIES_FILE_NAME}"
...
FC_PREDICTED_CROPPED_TRAIN_5M_ZERNIKE_COMPLEX_INTENSITIES_FIELDS_FILE_PREFIX = f"{FC_PREDICTED_TRAIN_COMPLEX_FIELDS_FOLDER_PATH}/fc_predicted_cropped_5M_{ZERNIKE_INTENSITIES_FILE_NAME}"
...
FC_PREDICTED_CROPPED_TRAIN_9M_ZERNIKE_COMPLEX_INTENSITIES_FIELDS_FILE_PREFIX = f"{FC_PREDICTED_TRAIN_COMPLEX_FIELDS_FOLDER_PATH}/fc_predicted_cropped_9M_{ZERNIKE_INTENSITIES_FILE_NAME}"
...
# Low dimensionality psf predictions projections
